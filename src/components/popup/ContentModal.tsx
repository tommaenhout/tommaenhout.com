...
const Content = ({ content, close } : ContentProps) => {
    ...
    setTimeout(() => {
      ...
      for (let i = 0; i < popupLink.length; i++) {
        ...
        element.addEventListener("click", () => {
          setOpen(true);
          const hidenElement = element.parentElement ? element.parentElement.getElementsByClassName("mfp-hide")[0] : {} as HTMLElement;
